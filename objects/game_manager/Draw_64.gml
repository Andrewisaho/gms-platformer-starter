...
/// @DnDVersion : 1
/// @DnDHash : 4C93BEB7
/// @DnDArgument : "code" "// Draw health bar - while player is alive$(13_10)// draw health bar as dead while player is dead$(13_10)if (instance_exists(object_player)) {$(13_10)	draw_healthbar(x, y, 175, 50, player1_health,$(13_10)		c_black, c_red, c_lime, 0, true, true)$(13_10)}$(13_10)else {$(13_10)	draw_healthbar(x, y, 175, 50, 0,$(13_10)		c_black, c_red, c_lime, 0, true, true) $(13_10)}"
